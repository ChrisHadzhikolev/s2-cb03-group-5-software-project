...
namespace ProjectMB
{
    public partial class ProductsForm : Form
    {
        ...
        {
            //MessageBox.Show(productsLb.SelectedItem.ToString());
            ////ProductForm productForm = new ProductForm(Products.FindProductByName(productsLb.SelectedItem.ToString()));
            ////productForm.Show();
            //if (Products.FindProductByName(productsLb.SelectedItem.ToString())==null)
            //{
